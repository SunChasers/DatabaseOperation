...
margin-left:20px;
 ...
 .l-button-submit{width:80px;margin-left:20px;margin-top:20px; padding-bottom:2px;}
	...
	<div id="layout1">
		...
		<div position="center" title="发布作业">
		
		      <form name="form1" method="post" action="setwork" id="form1">	 
		      <p>标题：</p>
		      <input type="text" name="title" style="width:300px;height:30px;"/>    
		      <p>开始时间：</p>
		      <input type="text" name="starttime" style="width:300px;height:30px;"/>  
		      <p>结束时间：</p>
		      <input type="text" name="endtime" style="width:300px;height:30px;"/>   
		      <p>作业内容：</p>
		      <textarea name="content" cols="100" rows="4" class="l-textarea" style="width:400px;margin-top:2px;margin-left:20px;"></textarea><br>
