...
<body style="padding:10px">
	...
	<div id="layout1">
		...
		<div position="center" title="案例浏览"
			...
			<div ligeruiid="maingrid4" class="l-panel" id="maingrid4"
				...
				<div class="l-panel-bwarp">
					<div class="l-panel-body">
						<div style="height: 500px;" id="maingrid4grid" class="l-grid">
								...
								<table cellpadding="0" cellspacing="0">
									<tbody>
										...
										<tr class="">
											...
											<td class="l-column-right">实例类型</td>
										</tr>
											...
											<tbody>
												<tr class="l-grid-hd-row">
													...
													<td columnname="CompanyName" columnindex="1"
														...
														id="maingrid4|hcell|c102" class="l-grid-hd-cell"><div
															class="l-grid-hd-cell-inner">
															<span class="l-grid-hd-cell-text">实例类型</span>
														</div>
													</td>			
											  ...
											  <% for(Example e:elist){%>
												...
												<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:120px;  "><div
															...
															style="width:103px;height:22px;min-height:22px; text-align:left;"><%=e.getID()%></div>
													</td>
													<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:250px;  "><div
															class="l-grid-row-cell-inner"
															style="width:160px;height:22px;min-height:22px; text-align:left;"><%=e.getExample_name()%></div>
													</td>
													<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:200px;  "><div
															class="l-grid-row-cell-inner"
															style="width:99px;height:22px;min-height:22px; text-align:left;"><%=e.getFiletype()%></div>
													</td>
													...
													<td id="maingrid4|2|r1001|c107" class="l-grid-row-cell "
														style="width:100px;  "><div
															class="l-grid-row-cell-inner"
															style="width:49px;height:22px;min-height:22px; "><a href="WebPage/TUI/deleteexample.jsp?delete=<%=e.getID()%>">删除</a></div>
													</td>																								</tr>
												<% }%>
											</tbody>
										</table>
				...
				<div class="l-panel-bar">
					<div class="l-panel-bbar-inner">
						<div class="l-bar-group  l-bar-message">
							<span class="l-bar-text"><a href="WebPage/TUI/deleteexample.jsp?delete=<%=deleteall %>">删除全部</a></span>
						</div>
