...
margin-left:20px;
 ...
 .l-button-submit{width:80px;margin-left:20px;margin-top:20px; padding-bottom:2px;}
	...
	<div id="layout1">
		...
		<div position="center" title="发布相关书籍">
		
		      <form name="form1" method="post" action="SetBookServerlet" id="form1">	 
		      <p>课程名称：</p>
		      <input type="text" name="BookName" style="width:400px;height:30px;"/>    
		      <p>课程介绍：</p>
		      <textarea name="BookIntroduce" cols="70" rows="20" class="l-textarea" style="width:400px;margin-top:2px;margin-left:20px;"></textarea><br>
