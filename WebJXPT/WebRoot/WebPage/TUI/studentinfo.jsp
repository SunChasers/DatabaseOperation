...
<body style="padding:10px">
	...
	<div id="layout1">
		...
		<div position="center" title="学生信息"
											  ...
											  <% for(Student student:slist){%>
												...
												<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
													...
													<td id="maingrid4|2|r1001|c108"
														...
														style="width:168px;  "><div
															class="l-grid-row-cell-inner"
															style="width:76px;height:22px;min-height:22px; "><a href="WebPage/TUI/deletestudentinfo.jsp?delete=<%=student.getSno()%>">删除</a></div>
													</td>
												</tr>
												<% }%>
											</tbody>
				...
				<div class="l-panel-bar">
					<div class="l-panel-bbar-inner">
						<div class="l-bar-group  l-bar-message">
							<span class="l-bar-text"><a href="WebPage/TUI/deletestudentinfo.jsp?delete=<%=deleteall%>">删除全部</a></span>
						</div>
