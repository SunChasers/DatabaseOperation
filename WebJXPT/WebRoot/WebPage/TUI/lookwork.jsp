...
<body style="padding:10px">
	...
	<div id="layout1">
		...
		<div position="center" title="作业浏览"
			...
			<div ligeruiid="maingrid4" class="l-panel" id="maingrid4"
				...
				<div class="l-panel-bwarp">
					<div class="l-panel-body">
						<div style="height: 530px;" id="maingrid4grid" class="l-grid">
											  ...
											  <% for(Work w:wlist){%>
												...
												<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:120px;  "><div
															...
															style="width:59px;height:22px;min-height:22px; text-align:left;"><%=w.getID()%></div>
													</td>
													<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:250px;  "><div
															class="l-grid-row-cell-inner"
															style="width:123px;height:22px;min-height:22px; text-align:left;"><%=w.getWork_title()%></div>
													</td>
													<td id="maingrid4|2|r1001|c101" class="l-grid-row-cell "
														style="width:200px;  "><div
															class="l-grid-row-cell-inner"
															style="width:99px;height:22px;min-height:22px; text-align:left;"><%=w.getStart_date() %></div>
													</td>
													<td id="maingrid4|2|r1001|c102" class="l-grid-row-cell "
														style="width:200px;  "><div
															class="l-grid-row-cell-inner"
															style="width:99px;height:22px;min-height:22px; "><%=w.getEnd_date()%>
															</div>
													</td>
													...
													<td id="maingrid4|2|r1001|c107" class="l-grid-row-cell "
														style="width:400px;  "><div
															class="l-grid-row-cell-inner"
															style="width:197px;height:22px;min-height:22px; "><%=w.getWork_content() %></div>
													</td>
													<td id="maingrid4|2|r1001|c107" class="l-grid-row-cell "
														style="width:100px;  "><div
															class="l-grid-row-cell-inner"
															style="width:49px;height:22px;min-height:22px; "><a href="WebPage/TUI/deletework.jsp?delete=<%=w.getID()%>">删除</a></div>
													</td>																								</tr>
												<% }%>
											</tbody>
										</table>
				...
				<div class="l-panel-bar">
					<div class="l-panel-bbar-inner">
						<div class="l-bar-group  l-bar-message">
							<span class="l-bar-text"><a href="WebPage/TUI/deletework.jsp?delete=<%=deleteall %>">删除全部</a></span>
						</div>
