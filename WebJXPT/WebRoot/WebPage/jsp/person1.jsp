						...
						<%  
							...
							try {
								if (contentType.indexOf("multipart/form-data") >= 0) {
									...
									if (checkFile.exists()) {
									%>
										<div class="equals_name_file"><a href="WebPage/jsp/person.jsp">亲,有和你的文件同名的文件，请修改文件名然后上传</a></div>
							...
							/*		File fileDir = new File(rootPath);
									...
									%>
									<div class="equals_name_file"><a href="WebPage/jsp/person.jsp">文件上传成功</a></div>
									<% }
								} else{
