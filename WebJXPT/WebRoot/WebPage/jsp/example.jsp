				...
				<div class="tips">
					...
					<!-- 
						...
						<li><img src="WebPage/img/down2.png"><a
						 ...
						 <li><img class="imgg" src="WebPage/img/gg.png" >
						 <form action="WebPage/jsp/example1.jsp"  enctype="application/x-www-form-urlencoded" name="forml">


  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请输入文档的关键字：<br>
 
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="search" type="text">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="Subnit" value="搜索">
    </form>
						</li>
						
                        <% for(Example example:elist){ %>
						<li><img src="WebPage/img/down2.png"><a
